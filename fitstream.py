# FitStream Life - Flask Web App (Corrected Version)
...
<body class="bg-white text-gray-800 font-sans">
    ...
    <section class="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-10 text-center">
        ...
        <div class="space-x-4">
            <a href="#" class="bg-white text-blue-600 font-semibold px-6 py-2 rounded-xl shadow-md inline-block">Start Your Fitness Plan</a>
            <a href="#" class="bg-white text-purple-600 font-semibold px-6 py-2 rounded-xl shadow-md inline-block">Explore Gear Guides</a>
        </div>
    </section>
